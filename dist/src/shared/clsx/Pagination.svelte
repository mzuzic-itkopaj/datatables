...
{#snippet small()}
    <button type="button" class={[ 'small', { disabled: table.currentPage === 1 }]} onclick={() => table.setPage(1)}>
        &#10092;&#10092;
    </button>
    ...
    <button type="button" class={[ 'small', { disabled: table.currentPage === table.pageCount }]} onclick={() => table.setPage('last')}>
        &#10093;&#10093;
    </button>
{/snippet}
